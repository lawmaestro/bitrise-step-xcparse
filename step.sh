...
ATTACHMENTS_ZIP="${TEMPORARY_DIRECTORY}/${attachments_archive_name}.zip"

CODECOVERAGE_OUTPUT_DIR="codecoverage"
CODECOVERAGE_OUTPUT_PATH="${TEMPORARY_DIRECTORY}/${CODECOVERAGE_OUTPUT_DIR}"
CODECOVERAGE_ZIP="${TEMPORARY_DIRECTORY}/${code_coverage_archive_name}.zip"

LOGS_OUTPUT_DIR="logs"
LOGS_OUTPUT_PATH="${TEMPORARY_DIRECTORY}/${LOGS_OUTPUT_DIR}"
LOGS_ZIP="${TEMPORARY_DIRECTORY}/${logs_archive_name}.zip"
